...
class Adv_Accordion extends Widget_Base
{
    ...
    {
        return esc_html__('Advanced Accordion', 'pixerex-elements');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Accordion Type', 'pixerex-elements'),
                'type' => Controls_Manager::SELECT,
                'default' => 'accordion',
                'label_block' => false,
                'options' => [
                    'accordion' => esc_html__('Accordion', 'pixerex-elements'),
                    'toggle' => esc_html__('Toggle', 'pixerex-elements'),
                ],
            ]
        );
        $this->add_control(
            ...
            [
                'label' => esc_html__('Enable Toggle Icon', 'pixerex-elements'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Icon Postion', 'pixerex-elements'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Right', 'pixerex-elements' ),
				'label_off' => __( 'Left', 'pixerex-elements' ),
                'default' => 'right',
                'return_value' => 'right',
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Icon', 'pixerex-elements'),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Toggle Speed (ms)', 'pixerex-elements'),
        ...
        $this->add_control(
            ...
            [
                ...
                'seperator' => 'before',
                'default' => [
                    ['eael_adv_accordion_tab_title' => esc_html__('Accordion Tab Title 1', 'pixerex-elements')],
                    ['eael_adv_accordion_tab_title' => esc_html__('Accordion Tab Title 2', 'pixerex-elements')],
                    ['eael_adv_accordion_tab_title' => esc_html__('Accordion Tab Title 3', 'pixerex-elements')],
                ],
                'fields' => [
                    [
                        'name' => 'eael_adv_accordion_tab_default_active',
                        'label' => esc_html__('Active as Default', 'pixerex-elements'),
                        'type' => Controls_Manager::SWITCHER,
                        'default' => 'no',
                        'return_value' => 'yes',
                    ],
                    [
                        ...
                        'label' => esc_html__('Enable Tab Icon', 'pixerex-elements'),
                        'type' => Controls_Manager::SWITCHER,
                        'default' => 'yes',
                        'return_value' => 'yes',
                    ],
                    ...
                    [
                        ...
                        'label' => esc_html__('Tab Title', 'pixerex-elements'),
                        'type' => Controls_Manager::TEXT,
                        'default' => esc_html__('Tab Title', 'pixerex-elements'),
                        'dynamic' => ['active' => true],
                    ],
                    [
                    ...
                    [
                        ...
                        'label' => esc_html__('Tab Content', 'pixerex-elements'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Tab Style', 'pixerex-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Distance', 'pixerex-elements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
        ...
        # Normal State Tab
        $this->start_controls_tab('eael_adv_accordion_header_normal', ['label' => esc_html__('Normal', 'pixerex-elements')]);
        $this->add_control(
        ...
        $this->start_controls_tab(
            ...
            [
                'label' => esc_html__('Active', 'pixerex-elements'),
            ]
        );
        $this->add_control(
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Toggle Caret Style', 'pixerex-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Icon Padding', 'pixerex-elements'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Icon Radius', 'pixerex-elements'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%', 'em' ],
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Caret Color', 'pixerex-elements'),
                'type' => Controls_Manager::COLOR,
                'default' => '#444',
                'selectors' => [
