        ...
        if(!class_exists('\WPForms\WPForms')) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => __( '<strong>WPForms</strong> is not installed/activated on your site. Please install and activate <strong>WPForms</strong> first.', 'px-elements'),
