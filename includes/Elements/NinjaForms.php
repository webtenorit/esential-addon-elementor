...
class NinjaForms extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Ninja Forms', 'pixerex-elements');
    }
    ...
    protected function _register_controls() {
        ...
        if(!function_exists('Ninja_Forms')) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => __( '<strong>Ninja Forms</strong> is not installed/activated on your site. Please install and activate <strong>Ninja Forms</strong> first.', 'pixerex-elements'),
            ...
            $this->start_controls_section(
                'section_info_box',
                [
                    'label'                 => __( 'Ninja Forms', 'pixerex-elements'),
                ]
            );
        ...
        $this->start_controls_section(
            ...
            [
                'label'                 => __( 'Required Fields Notice', 'pixerex-elements'),
                'tab'                   => Controls_Manager::TAB_STYLE,
            ]
        );
