...
class WeForms extends Widget_Base
{
    ...
    {
        return esc_html__('weForm', 'pixerex-elements');
    }
    ...
    protected function _register_controls()
    {
        ...
        if(!function_exists('WeForms')) {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'raw' => __('<strong>WeForms</strong> is not installed/activated on your site. Please install and activate <strong>WeForms</strong> first.', 'pixerex-elements'),
            ...
            $this->add_control(
                'wpuf_contact_form',
                [
                    'label' => esc_html__('Select weForm', 'pixerex-elements'),
                    'description' => esc_html__('Please save and refresh the page after selecting the form', 'pixerex-elements'),
                    'label_block' => true,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Form Container Styles', 'pixerex-elements'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Form Fields Styles', 'pixerex-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Input Field Background', 'pixerex-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Input Width', 'pixerex-elements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Textarea Width', 'pixerex-elements'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range' => [
                    'px' => [
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => esc_html__('Fields Padding', 'pixerex-elements'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors' => [
                    '{{WRAPPER}} .eael-weform-container ul.wpuf-form li .wpuf-fields input[type="text"],
        ...
        $this->add_control(
            ...
            [
                ...
                'label' => esc_html__('Focus State Style', 'pixerex-elements'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Field Font Color', 'pixerex-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .eael-weform-container ul.wpuf-form li .wpuf-fields input[type="text"],
					 {{WRAPPER}} .eael-weform-container ul.wpuf-form li .wpuf-fields input[type="password"],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Placeholder Font Color', 'pixerex-elements'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Label Typography', 'pixerex-elements'),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__('Input Fields Typography', 'pixerex-elements'),
                'separator' => 'before',
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Submit Button Styles', 'pixerex-elements'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->start_controls_tab('eael_weform_submit_btn_hover', ['label' => esc_html__('Hover', 'pixerex-elements')]);
