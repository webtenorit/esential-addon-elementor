...
class Woo_Checkout extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Woo Checkout', 'pixerex-elements' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'General Settings', 'pixerex-elements' ),
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Order Details', 'pixerex-elements' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Change Labels', 'pixerex-elements' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Product Text', 'pixerex-elements' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Product', 'pixerex-elements' ),
				'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Quantity Text', 'pixerex-elements' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Quantity', 'pixerex-elements' ),
				'condition' => [
					'ea_woo_checkout_table_header_text' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Price Text', 'pixerex-elements' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Price', 'pixerex-elements' ),
				'condition' => [
					'ea_woo_checkout_table_header_text' => 'yes',
				],
			]
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Shop Link', 'pixerex-elements' ),
				'type' => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default' => 'yes',
			]
		...
		$this->add_control(
			...
			[
				'label' => __( 'Link Text', 'pixerex-elements' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Continue Shopping', 'pixerex-elements' ),
				'condition' => [
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Coupon', 'pixerex-elements' ),
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Login', 'pixerex-elements' ),
			]
		);
		$this->add_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Section Title', 'pixerex-elements' ),
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Bottom Gap', 'pixerex-elements' ),
		...
		$this->add_control(
			...
			[
				'label' => __( 'Table Head', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
                'condition' => [
		...
		$this->add_control(
			...
			[
				'label' => esc_html__( 'Header Color', 'pixerex-elements' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#ffffff',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Table Body', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Row Gap', 'pixerex-elements' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 10,
				],
		...
		$this->add_control(
			...
			[
				'label' => __( 'Table Footer', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_tab( 'ea_woo_checkout_order_review_footer_link_color_tab_normal', [ 'label' => esc_html__( 'Normal', 'pixerex-elements' ) ] );
		...
		$this->start_controls_tab( 'ea_woo_checkout_order_review_footer_link_color_tab_hover', [ 'label' => esc_html__( 'Hover', 'pixerex-elements' ) ] );
		...
		$this->start_controls_tab( 'ea_woo_checkout_order_review_footer_link_color_tab_normal_pro', [ 'label' =>
            esc_html__( 'Normal', 'pixerex-elements' ) ] );
		...
		$this->start_controls_tab( 'ea_woo_checkout_order_review_footer_link_color_tab_hover_pro', [ 'label' =>
            esc_html__( 'Hover', 'pixerex-elements' ) ] );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Total', 'pixerex-elements' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'ea_woo_checkout_layout!' => 'default',
		...
		$this->add_control(
			...
			[
				'label' => __( 'Shop Link', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
				'condition' => [
					'ea_woo_checkout_shop_link' => 'yes',
		...
		$this->start_controls_tab( 'ea_woo_checkout_shop_link_color_tab_normal', [ 'label' => esc_html__( 'Normal', 'pixerex-elements' ) ] );
		...
		$this->start_controls_tab( 'eea_woo_checkout_shop_link_color_tab_hover', [ 'label' => esc_html__( 'Hover', 'pixerex-elements' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Links Color', 'pixerex-elements' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#7866ff',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Links Hover Color', 'pixerex-elements' ),
				'type' => Controls_Manager::COLOR,
				'default' => '#7866ff',
				'selectors' => [
		...
		$this->add_control(
			...
			[
				'label' => __( 'Form Label', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Notices', 'pixerex-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_group_control(
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Customer Details', 'pixerex-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab( 'ea_woo_checkout_customer_details_field_tab_normal', [ 'label' => esc_html__( 'Normal', 'pixerex-elements' ) ] );
		...
		$this->start_controls_tab( 'ea_woo_checkout_customer_details_field_tab_normal_hover', [ 'label' => esc_html__( 'Hover', 'pixerex-elements' ) ] );
		...
		$this->add_responsive_control(
			...
			[
				'label' => __( 'Bottom Spacing (PX)', 'pixerex-elements' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 5,
				],
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Payment', 'pixerex-elements' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		$this->add_control(
		...
		$this->start_controls_tab(
			...
			[
				'label' => __( 'Selected', 'pixerex-elements' ),
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Methods Info', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				'label' => __( 'Privacy Policy', 'pixerex-elements' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				'label' => esc_html__( 'Top Spacing', 'pixerex-elements' ),
				'type' => Controls_Manager::SLIDER,
				'default' => [
					'size' => 20,
				],
