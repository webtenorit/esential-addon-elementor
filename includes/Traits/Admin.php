...
trait Admin
{
    ...
    {
        add_menu_page(
            __('Pixerex Elements', 'pixerex-elements'),
            __('Pixerex Elements', 'pixerex-elements'),
            'manage_options',
            'eael-settings',
        ...
        // if (!in_array('templately/templately.php', $plugins)) {
            /*add_submenu_page(
                'eael-settings',
                __('Templates Cloud', 'pixerex-elements'),
                __('Templates Cloud', 'pixerex-elements'),
                'manage_options',
                'template-cloud',
    ...
    public function templately_page()
    {
        ...
        $button_text = __('Install Templately', 'pixerex-elements');
        ...
        if (isset($plugins['templately/templately.php'])) {
            $installed = true;
            $button_text = __('Activate Templately', 'pixerex-elements');
        }
                        ...
                        <div class="template-cloud-install">
                            <div class="templately-left">
                                <div class="templately-cloud-title">
                                    <h1><?php echo __( 'Explore 100+ Free Templates', 'pixerex-elements' ); ?></h1>
                                    <p><?php echo __( 'From multipurpose themes to niche templates, you’ll always find something that catches your eye.', 'pixerex-elements' ); ?></p>
                                </div>
                            </div>
                            <div class="templately-installer-wrapper">
                                ...
                                <div class="templately-right">
                                    <div class="templately-admin-install">
                                        <p><?php echo __( 'Install Templately by Essential Addons to get access to the templates library and cloud.', 'pixerex-elements' ); ?></p>
        ...
        if (isset($hook) && $hook == 'toplevel_page_eael-settings') {
            ...
            $i18n = [
                    'login_register' => [
                            ...
                            'm_title' => __('Login | Register Form Settings', 'pixerex-elements'),
                            'm_footer' => __('To retrieve your API Keys, click here', 'pixerex-elements'),
                            'save' => __('Save', 'pixerex-elements'),
                            'cancel' => __('Cancel', 'pixerex-elements'),
                            'rm_title' => __('Login | Register Form Settings Saved', 'pixerex-elements'),
                            'rm_footer' => __('Reload the page to see updated data', 'pixerex-elements'),
                            'e_title' => __('Oops...', 'pixerex-elements'),
                            'e_text' => __('Something went wrong!', 'pixerex-elements'),
                            'r_title' => __('reCAPTCHA v2', 'pixerex-elements'),
                            'r_sitekey' => __('Site Key', 'pixerex-elements'),
                            'r_sitesecret' => __('Site Secret', 'pixerex-elements'),
                            'g_title' => __('Google Login', 'pixerex-elements'),
                            'g_cid' => __('Google Client ID', 'pixerex-elements'),
                            'f_title' => __('Facebook Login', 'pixerex-elements'),
                            'f_app_id' => __('Facebook APP ID', 'pixerex-elements'),
                            'f_app_secret' => __('Facebook APP Secret', 'pixerex-elements'),
                    ]
            ];
		  	...
		  	<form action="" method="POST" id="eael-settings" name="eael-settings">
		  		<div class="eael-header-bar">
					<div class="eael-header-left">
						...
						<h2 class="title"><?php echo __('Essential Addons Settings', 'pixerex-elements'); ?></h2>
					</div>
					<div class="eael-header-right">
					<button type="submit" class="button eael-btn js-eael-settings-save"><?php echo __('Save settings', 'pixerex-elements'); ?></button>
					</div>
				</div>
			  	<div class="eael-settings-tabs">
			    	<ul class="eael-tabs">
				      	<!-- <li><a href="#general" class="active"><img src="<?php echo EAEL_PLUGIN_URL . '/assets/admin/images/icon-general.svg'; ?>" alt="essential-addons-general-settings"><span><?php echo __('General', 'pixerex-elements'); ?></span></a></li> -->
				      	<li><a href="#elements"><img src="<?php echo EAEL_PLUGIN_URL . '/assets/admin/images/icon-elements.svg'; ?>" alt="essential-addons-elements"><span><?php echo __('Elements', 'pixerex-elements'); ?></span></a></li>
                        <li><a href="#extensions"><img src="<?php echo EAEL_PLUGIN_URL . '/assets/admin/images/icon-extensions.svg'; ?>" alt="essential-addons-extensions"><span><?php echo __('Extensions', 'pixerex-elements'); ?></span></a></li>
                        <li><a href="#tools"><img src="<?php echo EAEL_PLUGIN_URL . '/assets/admin/images/icon-tools.svg'; ?>" alt="essential-addons-tools"><span><?php echo __('Tools', 'pixerex-elements'); ?></span></a></li>
                        <?php /* if (!$this->pro_enabled) {?>
                            <li><a href="#go-pro"><img src="<?php echo EAEL_PLUGIN_URL . '/assets/admin/images/icon-upgrade.svg'; ?>" alt="essential-addons-go-pro"><span><?php echo __('Go Premium', 'pixerex-elements'); ?></span></a></li>
                        <?php } */ ?>
                    </ul>
                    <?php
// include_once EAEL_PLUGIN_PATH . DIRECTORY_SEPARATOR . 'includes/templates/admin/general.php';
    ...
    public function save_settings()
    {
	    ...
	    if ( !empty( $_POST['is_login_register']) ) {
		    ...
		    wp_send_json_success( ['message'=> __('Login | Register Settings updated', 'pixerex-elements')]);
        }
    ...
    public function admin_notice()
    {
        ...
        $notice->links = [
            'review' => array(
                'later' => array(
                    ...
                    'target' => '_blank',
                    'label' => __('Ok, you deserve it!', 'pixerex-elements'),
                    'icon_class' => 'dashicons dashicons-external',
                ),
                'allready' => array(
                    'link' => $url,
                    'label' => __('I already did', 'pixerex-elements'),
                ...
                'maybe_later' => array(
                    'link' => $url,
                    'label' => __('Maybe Later', 'pixerex-elements'),
                ...
                'support' => array(
                    ...
                    'label' => __('I need help', 'pixerex-elements'),
                    'icon_class' => 'dashicons dashicons-sos',
                ),
                'never_show_again' => array(
                    'link' => $url,
                    'label' => __('Never show again', 'pixerex-elements'),
         ...
         */
        $notice->message('review', '<p>' . __('We hope you\'re enjoying Essential Addons for Elementor! Could you please do us a BIG favor and give it a 5-star rating on WordPress to help us spread the word and boost our motivation?', 'pixerex-elements') . '</p>');
        ...
        // $notice->message('upsale', '<p>' . __('5,000+ People using <a href="https://betterdocs.co/wordpress-plugin" target="_blank">BetterDocs</a> to create better Documentation & Knowledge Base!', 'pixerex-elements') . '</p>');
        ...
        if ($this->pro_enabled && \version_compare(EAEL_PRO_PLUGIN_VERSION, '4.0.0', '<')) {
            ...
            $notice->message('update', '<p>' . __('You are using an incompatible version of Essential Addons PRO. Please update to v4.0.0+. If you do not see automatic update, <a href="https://essential-addons.com/elementor/docs/manually-update-essential-addons-pro/" target="_blank">Follow manual update guide.</a>', 'pixerex-elements') . '</p>');
        ...
        //     'file' => 'betterdocs.php',
        //     'btn_text' => __('Install Free', 'pixerex-elements'),
        //     'condition' => [
        //         'by' => 'class',
        //         'class' => 'BetterDocs',
        //     ],
