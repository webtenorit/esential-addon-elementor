...
trait Elements
{
    ...
    public function register_widget_categories($elements_manager)
    {
        $elements_manager->add_category(
            ...
            [
                'title' => __('Essential Addons', 'pixerex-elements'),
                'icon' => 'font',
            ], 1);
    }
    ...
    public function promote_pro_elements($config)
    {
        ...
        $combine_array = array_merge($promotion_widgets, [
            ...
            [
                ...
                'title' => __('Google Map', 'pixerex-elements'),
            ...
            [
                ...
                'title' => __('Interactive Card', 'pixerex-elements'),
            ...
            [
                ...
                'title' => __('LearnDash Course List', 'pixerex-elements'),
